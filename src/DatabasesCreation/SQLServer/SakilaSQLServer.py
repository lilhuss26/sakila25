from src.DatabasesCreation.SQLServer.configuration import fetcher
from src.DatabasesCreation.SQLServer.insertion import *
from src.DatabasesCreation.SQLServer.views import create_views


class SakilaSQLServer:
    def __init__(self):
