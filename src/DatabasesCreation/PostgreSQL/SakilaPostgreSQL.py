from src.DatabasesCreation.PostgreSQL.configuration import fetcher
from src.DatabasesCreation.PostgreSQL.insertion import *
from src.DatabasesCreation.PostgreSQL.views import create_views


class SakilaPostgreSQL:
    def __init__(self):
